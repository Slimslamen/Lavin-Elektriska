...
export default function ShopCards({ bundle, onSelect }) {
    const Icon = bundle.icon;
    
  return (
     <div className={`${bundle.name === "Standardpaket" ? "outline-[#66BEF0] outline-1" : ""} bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col h-[60vh]`}>
