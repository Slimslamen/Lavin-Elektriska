              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Vi samlar in personuppgifter när du kontaktar oss för våra tjänster, begär offerter eller 
                    använder vår webbplats. De uppgifter vi samlar in kan inkludera:
                  </p>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Vi delar inte dina personuppgifter med tredje part utan ditt samtycke, förutom när det 
                    krävs enligt lag eller för att utföra våra tjänster (t.ex. leverantörer av specialutrustning).
                  </p>
                </div>
            ...
            <div className="border-t border-gray-200 pt-16">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Lavin Elektriska tillhandahåller professionella elektriska tjänster för bostäder och 
                    kommersiella fastigheter. Alla tjänster utförs enligt gällande säkerhetsföreskrifter 
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Priser anges i svenska kronor och inkluderar moms där det är tillämpligt. 
                    Betalning ska ske enligt överenskomna villkor, vanligtvis inom 30 dagar från fakturadatum.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Vi garanterar vårt arbete enligt branschstandarder. Garantin täcker fel i utförandet 
                    men inte normal förslitning eller skador orsakade av missbruk.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Vårt ansvar begränsas till direkta skador som uppstår på grund av vårt försummelse. 
                    Vi har erforderlig försäkring för våra tjänster.
                  </p>
                </div>
